...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var webhookMiddeware, payload, cartRouter;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                webhookMiddeware = body_parser_1.default.json({
                    verify: function (req, _, buffer) {
                        req.rawBody = buffer;
                    }
                });
                app.post("/api/webhooks/stripe", webhookMiddeware, webhooks_1.stripeWebhookHandler);
